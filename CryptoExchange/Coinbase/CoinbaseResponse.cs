...
namespace CryptoExchange.Coinbase
{
    ...
    public class Notification : CoinbaseResponse
    {
        ...
        /// Verify the notification by calling CryptoExchange.VerifyNotification() with the Notification and the associated "X-Signature" (or CB-SIGNATURE) request header value.
        /// </summary>
        //[JsonIgnore]
        ...
        //                "Verify the notification by calling CryptoExchange.VerifyNotification() " +
